...
@section('content')
    <div class="mx-3 my-6 md:mx-auto md:max-w-7xl">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-6">
            ...
            <form action="{{ route('academic-year.update', ['academic_year' => $year->id]) }}" method="post" id="addform"
                ...
                <div class="collapse collapse-plus bg-base-100 border border-base-300">
                    ...
                    <div class="collapse-content text-sm grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mt-4">
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" class="input w-full" placeholder="Type here" name="tahun1"
                                    value="{{ old('tahun1', $year->tahun1) }}" onkeyup="onlyNumbers(this)"
                                    autocomplete="off" maxlength="4" id="tahun1" />
                                <label class="leading-10">/</label>
                                <input type="text" class="input w-full" placeholder="Type here" name="tahun2"
                                    value="{{ old('tahun2', $year->tahun2) }}" onkeyup="onlyNumbers(this)"
                                    autocomplete="off" maxlength="4" id="tahun2" />
                            </div>
                            @error('tahun1')
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea placeholder="Type here ...." name="catatan" class="textarea w-full textarea-md resize-none">{{ old('catatan', $year->catatan) }}</textarea>
                            @error('catatan')
                                <p class="mt-2 text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
